...
public class IPServiceImpl extends BaseServiceCompnent implements IPService {
	...
	public ResultCodeVo search(String json) {
		...
		return new ResultCodeVo(true, 0, "success", sysIPMapper.search(map));
	}
	...
	public ResultCodeVo situation(String json) {
		return new ResultCodeVo(true, 0, "success", sysIPMapper.situation());
	}

	public ResultCodeVo count(String json) {
		return new ResultCodeVo(true, 0, "success", sysIPMapper.count());
	}

	public ResultCodeVo avgsituation(String json) {
		return new ResultCodeVo(true, 0, "success", sysIPMapper.avgsituation());
	}
